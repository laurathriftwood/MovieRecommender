...
import implicit
from train_test_model import train_model, evaluate_model
...
modelfactor = 20
#storeAUC, popularityAUC = evaluate_model(testsparse, list[1,2,3], predictions, test_set) 
...
class TestTrainEvaluateModel(unittest.TestCase):
    ...
    #test to make sure evaluation of model
